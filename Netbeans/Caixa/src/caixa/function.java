...
public class function extends gui{
	...
	public static void sendMail(){
            ...
            try {
                  ...
                  Address[] toUser = InternetAddress.parse("evconta1@gmail.com");//Destinatario
				  
                  message.setRecipients(Message.RecipientType.TO, toUser);
				  
                  message.setSubject("Loja 1 - CAIXA - "+meses[month]+" - "+dateFormat.format(date));//Assunto
	...
	public static void sum(){
		...
		*/
		...
		JTextField[] variaveis =	{totalvendas,caixadiaanterior,caixaatual,totaldinheiro,totalcartao,retirada,
										retirada1,retirada2,retirada3,acrescimo,ped};
			
		for (int i = 0; i<11; i++){
			if("".equals(variaveis[i].getText())){
				variaveis[i].setText("0");
			}
		}
